  ...
  return (
    <div className="rounded-2xl overflow-hidden card-glow-amber transition-transform duration-200 hover:-translate-y-0.5" style={{ background: 'rgba(245,158,11,0.06)', border: '1px solid rgba(245,158,11,0.2)' }}>
      ...
      <div className="p-5">
        ...
        {/* Per-speaker bars */}
        {speakers.length > 0 && (
          <div className="mb-4 border-t border-[color:var(--db-border)] pt-3">
        ...
        {/* Notes */}
        {sentiment.notes && (
          <p className="text-gray-400 text-sm leading-relaxed border-t border-[color:var(--db-border)] pt-3">{sentiment.notes}</p>
        )}
