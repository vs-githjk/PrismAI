      ...
      >
        ...
        <div className="flex items-end gap-2">
          ...
          <textarea
            ...
            className="flex-1 resize-none overflow-y-auto rounded-lg border border-white/[0.10] bg-[#0d0e10] px-3 py-2.5 text-sm leading-5 text-white outline-none transition placeholder:text-white/35 focus:border-cyan-400/60 focus:ring-1 focus:ring-cyan-400/20 disabled:cursor-not-allowed disabled:opacity-50"
          />
          <button
            type="button"
            onClick={() => send()}
