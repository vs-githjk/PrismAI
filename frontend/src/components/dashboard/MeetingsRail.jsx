...
export default function MeetingsRail({ history, onSelect }) {
          ...
          {meetings.map((entry, index) => {
            ...
            return (
              <button
                ...
                className="min-h-[122px] w-[240px] flex-shrink-0 snap-start rounded-xl border border-white/[0.1] bg-black/22 p-3 text-left transition hover:-translate-y-0.5 hover:border-cyan-200/30 hover:bg-white/[0.055] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-cyan-300/16"
