...
export default function LiveMeetingView({ token, onStatusChange }) {
  ...
  if (error) return (
    <div className="mx-auto max-w-2xl py-16 text-center">
      <p className="text-sm text-[color:var(--db-text-muted)]">{error}</p>
    </div>
  )
  ...
  if (!data) return (
    <div className="mx-auto flex max-w-2xl flex-col items-center gap-3 py-16">
      ...
      <p className="text-xs text-[color:var(--db-text-faint)]">Connecting to live meeting…</p>
    </div>
  )
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      {standinUpdates.length > 0 && (
        <div className="rounded-2xl overflow-hidden" style={{ background: 'var(--db-fill)', border: '1px solid rgba(34,211,238,0.14)' }}>
          <div className="px-4 py-2.5 flex items-center gap-2" style={{ borderBottom: '1px solid var(--db-border)' }}>
      ...
      {/* Prism commands log */}
      {commands.length > 0 && (
        <div className="rounded-2xl overflow-hidden" style={{ background: 'var(--db-fill)', border: '1px solid var(--db-border)' }}>
          <div className="px-4 py-2.5 flex items-center gap-2" style={{ borderBottom: '1px solid var(--db-border)' }}>
