const AGENT_CONFIG = {
  summarizer: { label: 'Summarizer', icon: '📝', bg: 'bg-indigo-500/15', border: 'border-indigo-500/35', text: 'text-indigo-300', dot: 'bg-indigo-400' },
  action_items: { label: 'Action Items', icon: '✅', bg: 'bg-purple-500/15', border: 'border-purple-500/35', text: 'text-purple-300', dot: 'bg-purple-400' },
  sentiment: { label: 'Sentiment', icon: '💬', bg: 'bg-yellow-500/15', border: 'border-yellow-500/35', text: 'text-yellow-300', dot: 'bg-yellow-400' },
  email_drafter: { label: 'Email Draft', icon: '✉️', bg: 'bg-emerald-500/15', border: 'border-emerald-500/35', text: 'text-emerald-300', dot: 'bg-emerald-400' },
  calendar_suggester: { label: 'Calendar', icon: '📅', bg: 'bg-pink-500/15', border: 'border-pink-500/35', text: 'text-pink-300', dot: 'bg-pink-400' },
}
