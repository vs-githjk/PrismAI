                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {rep.followup_brief && (
                      <div className="mt-2">
                        ...
                        {openBrief === rep.id && (
                          <div className="mt-2 rounded-lg border border-[color:var(--db-border)] bg-[var(--db-fill)] px-3 py-2.5">
                            <p className="whitespace-pre-wrap text-[12px] leading-relaxed text-[color:var(--db-text)]">{rep.followup_brief}</p>
