...
SYSTEM_PROMPT = (
    ...
    "pattern in the transcript when one exists; 'neutral' is the honest call for routine "
    "or purely informational exchanges — never invent drama to avoid it.\n"
    "An informal working, testing, or debugging session that accomplished what it set out "
    "to do is 'exploratory' or 'collaborative' — do NOT label a meeting 'draining' merely "
    "because it was unstructured, brief, or task-focused. Reserve 'draining' for genuinely "
    "circular, energy-sapping dynamics the participants themselves seemed worn down by.\n\n"
